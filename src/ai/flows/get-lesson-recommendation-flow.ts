...
2.  Filter out any lessons that are primarily about "Speaking" ("Говорение", "Speaking", "Практика говорения", "Speech practice"). Do NOT recommend these.
3.  From the remaining uncompleted lessons, determine the most logical "next" lesson. This is typically the first uncompleted lesson in the sequence.
...
6.  If all valid (non-speaking) lessons are completed, or if the plan is empty:
